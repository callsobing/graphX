 ...
 */
public class MakeEdgeRawToTuple implements PairFunction<String, Long, Tuple2<Long, Tuple2<Float, String>>> {
    @Override
    public Tuple2<Long, Tuple2<Long, Tuple2<Float, String>>> call(String line) throws Exception {
        ...
        return new Tuple2<>(long1, new Tuple2<>(long2, new Tuple2<>(score, info)));
    }
}